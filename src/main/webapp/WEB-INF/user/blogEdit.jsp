...
<html lang="en">
  ...
  <body>
    ...
    <div>
    <%
    	String selectValue = (String) request.getAttribute("tag");
    %>
      <form
      ...
      >
        <div class="container">
            <div class="form-title">UPDATE BLOG</div>
          ...
          <div class="form-group">
            ...
            <select name="tag" class="form-control" required >
              ...
              <option value="Travel"
              <% if (selectValue.equals("Travel")) { %>
              selected
              <% } %>
              >Travel</option>
              <option value="Food"
              <% if (selectValue.equals("Food")) { %>
              selected
              <% } %>
              >Food</option>
              <option value="Tech"
              <% if (selectValue.equals("Tech")) { %>
              selected
              <% } %>
              >Tech</option>
              <option value="Movie"
              <% if (selectValue.equals("Movie")) { %>
              selected
              <% } %>
              >Movie</option>
            </select>
